  ...
  return (
    <Container>
      ...
      >
        ...
        <SectionDescription>
          매 학기 MT를 통해 신입 부원들과 기존 부원들이 하나 되는 시간을 가지며,
          매년 말 학술제에서는 우리의 성장을 뽐내고 있습니다. 더불어 자체
          해커톤을 개최하여 다양한 팀 프로젝트를 진행하며, 서로의 기술과
      ...
      >
        ...
        <SectionDescription>
          세미나, 스터디, 튜터링을 통해 체계적인 성장을 이뤄갑니다. 관심 분야의
          전문성을 키우고 싶은 분들에게 최적의 환경을 제공하며, 서로 배우고
          가르치며 함께 성장하는 학습 문화를 만들어가고 있습니다.
        </SectionDescription>
        <CardGrid>
          <ImageBox
            img={pnn1}
